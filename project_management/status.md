...
| add scaling amounts of green based on triggers/sec. (autotyper) | medium | low |
| add option to make progress happen while tab isnt focused | medium | low |
